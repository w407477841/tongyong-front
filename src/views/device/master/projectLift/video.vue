...
<div class="container-box condition-box" style="overflow-y:scroll;height:100%;">
    <div class="video">
        <el-row class="boxCard-group" :gutter="16">
                ...
                <div class="boxCard">
                    <div class="video__main">
                        <!-- <HK-monitor v-if="flag" :baseInfo="baseInfo" @channels="getChannels" @g_iWndIndex="getIWndIndex"></HK-monitor> -->
                         <HK-monitor v-if="flag && baseInfo.platformType == 1" :tag="0" :cameraIndex="cameraIndex" :baseInfo="baseInfo" :isGroup="false" @channels="getChannels" @g_iWndIndex="getIWndIndex" :isCapturePic="false"></HK-monitor>
                          ...
                          <YS-monitor v-if="baseInfo.platformType == 4"  :projectId="projectId" :pageSize="9" :pageIndex="0" :appkey="appkey" :secret="secret"></YS-monitor>
                    </div>
                </div>
            </el-col>
            <el-col :xs="24" :sm="8" :lg="8" class="boxCard-col" :span="8">
                        ...
                        <div class="video__setter" style="height:200px;">
                            <el-form ref="form" :model="form" label-width="125px" size="mini" label-position="left">
                                <el-form-item label="录像文件保存路径">
                                    <el-col :span="18">
                                        <el-input v-model="form.videoFile"></el-input>
                                    </el-col>
                                    <el-col :span="4">
                                ...
                                <el-form-item label="回放下载保存路径">
                                    <el-col :span="18">
                                        <el-input v-model="form.pbDownload"></el-input>
                                    </el-col>
                                    <el-col :span="4">
                                ...
                                <el-form-item label="预览抓图保存路径">
                                    <el-col :span="18">
                                        <el-input v-model="form.pvScreenshot"></el-input>
                                    </el-col>
                                    <el-col :span="4">
                        ...
                        <div class="video__optionS">
                            <div class="video__direction">
                                ...
                                <el-row :gutter="24">
                                    ...
                                    <el-col :span="6">
                                        <el-button size="mini" style="width:60px" @mousedown.native="mouseDownPTZControl(8)" @mouseup.native="mouseUpPTZControl">右上</el-button>
                                    </el-col>
                                </el-row>
                            </div>
...
import YSMonitor from "@/components/video/YSMonitor.vue";
export default {
  data() {
    return {
      baseInfo: {},
  ...
  mounted() {
    ...
    this.cameraIndex = sessionStorage.getItem("tunnel");
  ...
  methods: {
    ...
    clickOpenFileDlg(id, iType) {
      ...
      if (szDirPath != -1 && szDirPath != "" && szDirPath != null) {
        if (id == "videoFile") {
          this.form.videoFile = szDirPath;
        } else if (id == "pbDownload") {
          this.form.pbDownload = szDirPath;
        } else if (id == "pvScreenshot") {
          this.form.pvScreenshot = szDirPath;
    ...
    clickSetLocalCfg() {
      ...
      arrXml.push("<RecordPath>" + this.form.videoFile + "</RecordPath>");
      arrXml.push("<CapturePath>" + this.form.pvScreenshot + "</CapturePath>");
      arrXml.push(
      ...
      arrXml.push("<DownloadPath>" + this.form.pbDownload + "</DownloadPath>");
    ...
    clickStartDownloadRecord(i) {
      console.log("clickStartDownloadRecord");
      if (
        !this.form.pbDownload ||
        this.form.pbDownload == "" ||
        !this.isSetLocalCfg
      ) {
