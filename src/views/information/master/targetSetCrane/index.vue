        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%"  highlight-current-row @selection-change="listSelectionChange"  header-row-class-name="xyTableHeader">
                    ...
                    <el-table-column label="最大幅度(m)" prop="maxRange"></el-table-column>
                    ...
                    <el-table-column label="额定力矩(N.m)" prop="fixMoment"></el-table-column>
                    <el-table-column label="风速(m/s)" prop="windSpeed"></el-table-column>
                    <el-table-column label="倾角(°)" prop="tiltAngle"></el-table-column>
...
import {
  getListApi,
  deleteInfoApi
} from "@/views/information/api/targetSetCrane.js";
...
export default {
  ...
  data() {
    return {
      operationPrex: "crane:infoMain:targetSetCrane",
      listData: [],
      isDangerous: "",
      keyword: "",
      pageIndex: 1,
