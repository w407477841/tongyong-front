                            ...
                            <el-row>
                                ...
                                <el-col :xs="24" :sm="12" :md="12">
                                    <el-form-item label="额定力矩(N.m)" prop="fixMoment">
                                        <el-input-number  :max="999999999999" :precision="2" v-model="formDatas.fixMoment" :controls="false" :disabled="edit" ></el-input-number>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="12">
                                    <el-form-item label="风速(m/s)" prop="windSpeed">
                                        <el-input-number  :max="999999999999" :precision="2" v-model="formDatas.windSpeed" :controls="false" :disabled="edit" ></el-input-number>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="12">
                                    <el-form-item label="倾角(°)" prop="tiltAngle">
                                        <el-input-number  :max="999999999999" :precision="2" v-model="formDatas.tiltAngle" :controls="false" :disabled="edit" ></el-input-number>
                                    </el-form-item>
                                </el-col>
  ...
  data() {
    return {
      ...
      formDatasRules: {
        ...
        maxRange: [
          { required: true, message: "请输入最大幅度", trigger: "blur" }
        ],
        maxWeight: [
          { required: true, message: "请输入最载重量", trigger: "blur" }
        ],
        standardHeight: [
          { required: true, message: "请输入标准高度", trigger: "blur" }
        ],
        fixMoment: [
          { required: true, message: "请输入额定力矩", trigger: "blur" }
        ],
