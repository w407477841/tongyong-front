    ...
    <div class="container-box list-box">
      <div class="table-box">
        <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row @selection-change="listSelectionChange" header-row-class-name="xyTableHeader">
          ...
          <el-table-column label="开始时间" prop="beginTime" :formatter="getBegin"></el-table-column>
          <el-table-column label="截止时间" prop="endTime" :formatter="getEnd"></el-table-column>
...
import { selectMonitorStatus } from "../../api/realTimeMonitoring(helmet).js";
...
export default {
  ...
  methods: {
    ...
    getDate: function(row) {
      let begin = new Date(row.createTime);
