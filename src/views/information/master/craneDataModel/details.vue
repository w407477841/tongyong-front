                                ...
                                <el-row>
                                    ...
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="司机" prop="driver">
                                            <el-input v-model="formDatas.driver" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>

                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="时间" prop="deviceTime">
                                            <el-input v-model="formDatas.deviceTime" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    ...
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="重量(t)" prop="weight">
                                            <el-input v-model="formDatas.weight" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="力矩(N·m)" prop="moment">
                                            <el-input v-model="formDatas.moment" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="高度(m)" prop="height">
                                            <el-input v-model="formDatas.height" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="幅度(m)" prop="range">
                                            <el-input v-model="formDatas.range" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="力矩百分比(%)" prop="momentPercentage">
                                            <el-input v-model="formDatas.momentPercentage" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="回转角度(°)" prop="rotaryAngle">
                                            <el-input v-model="formDatas.rotaryAngle" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
                                        <el-form-item label="倾斜角度(°)" prop="tiltAngle">
                                            <el-input v-model="formDatas.tiltAngle" :disabled="edit" :maxlength="20"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :xs="24" :sm="8" :md="8" style="height: 50px;">
