<template>
    <el-dialog width="80%" :title="title" :visible.sync="illegalInfoDetails" append-to-body>
            ...
            <div class="container-box list-box">
                <div class="table-box">
                    <el-table size="small" :data="listData" style="width: 100%"  highlight-current-row
                        ...
                        <el-table-column label="违章时间" prop="createTime"></el-table-column>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            visible: {
                handler: function(val, oldVal) {
                    this.illegalInfoDetails = val;
                },
                immediate: true
            },
            illegalInfoDetails(val) {
                if (!val) {
                    this.$emit('close', {});
                }
            }
