                               ...
                               <el-col :xs="24" :sm="24" :md="24">
                                 ...
                                 <el-col :xs="24" :sm="12" :md="12">
                                     <el-form-item label="指定人" prop="relatedUser">
                                          ...
                                          <el-select v-model="formDatas.relatedUser"   multiple
...
<script>
import {  insertInfoApi, updateInfoApi,getUserListApi,getMessModleListApi,insertMessage } from '@/views/information/api/lift.js';
  ...
  data() {
    return {
      ...
      formDatasRules: {
         ...
         relatedUser:[{ required: true, message: '请选择指定人',trigger:"blur" }]
