    ...
    <div class="container-box list-box">
      <div class="table-box">
        <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row @selection-change="listSelectionChange" header-row-class-name="xyTableHeader">
          ...
          <el-table-column label="开机时间" prop="createTime"></el-table-column>
          <el-table-column label="关机时间" prop="endTime"></el-table-column>
          <el-table-column label="总运行时长" prop="duration"></el-table-column>
