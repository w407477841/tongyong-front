        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%" highlight-current-row
                   ...
                   <el-table-column label="超载违章" prop="alarmAll"></el-table-column>
            ...
            <illegalInfoDetails v-if="illegalInfoDetails" :visible.sync="illegalInfoDetails" @close="closeDialog"
                                :routeType="detailsType" :detailsId="detailsId"></illegalInfoDetails>
            <illegalInfoSMS v-if="illegalInfoSMS" :visible.sync="illegalInfoSMS" @close="closeDialog"
                              :routeType="detailsType" :detailsId="detailsId"></illegalInfoSMS>
        </div>
    </div>
</template>

<script>
    import {countViolation} from "@/views/information/api/lift.js";
    import liftWarningButton from "./liftWarningButton";
    import illegalInfoSMS from './illegalInfoSMS';
    import illegalInfoDetails from './illegalInfoDetails';
    ...
    export default {
        ...
        data() {
            return {
                ...
                isOnline: null,
                projectId: null,
                illegalInfoDetails: false,
                illegalInfoSMS: false,
                pageIndex: 1,
                pageSizes: [10, 20, 30],
                pageSize: 10,
                pageTotal: 0,
    ...
    dateChange : function() {
      if(this.checkTime == 1) {
        ...
        this.dateShow = false;
            ...
            getListData() {
                countViolation(this.params).then(res => {
            ...
            //查看详情弹窗
            viewDetails() {
                this.illegalInfoDetails = true;
            },
            //短信告警弹窗
            SMSRemind() {
                this.illegalInfoSMS = true;
            },
            closeDialog() {
                this.illegalInfoDetails = false;
                this.illegalInfoSMS = false;
                //this.handelGet() ;
            }
        }
    };
