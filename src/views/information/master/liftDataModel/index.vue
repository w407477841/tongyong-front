        ...
        <div class="container-box list-box">
            <div class="table-box">
                <el-table size="small" :data="listData" style="width: 100%" height="100%"  highlight-current-row @selection-change="listSelectionChange"  header-row-class-name="xyTableHeader">
                    ...
                    <el-table-column label="速度(m/s)" :show-overflow-tooltip="true" prop="speed"></el-table-column>
                    <el-table-column label="人数(人)" :show-overflow-tooltip="true" prop="people"></el-table-column>
                    <el-table-column label="前门状态" :show-overflow-tooltip="true" prop="frontDoorStatus"></el-table-column>
                    <el-table-column label="后门状态" :show-overflow-tooltip="true" prop="backDoorStatus"></el-table-column>
                    <el-table-column label="状态" :show-overflow-tooltip="true" prop="status"></el-table-column>
                    <el-table-column label="楼层" :show-overflow-tooltip="true" prop="floor"></el-table-column>
                    <el-table-column label="启动楼层" :show-overflow-tooltip="true" prop="floorStart"></el-table-column>
                    <el-table-column label="停止楼层" :show-overflow-tooltip="true" prop="floorEnd"></el-table-column>
                    <el-table-column label="倾角" :show-overflow-tooltip="true" prop="tiltAngle"></el-table-column>
...
import {
  getListApi,
  deleteInfoApi
} from "@/views/information/api/liftDataModel.js";
...
export default {
  ...
  data() {
    return {
      ...
      detailsType: null,
      detailsId: null,
      operationPrex: "lift:infoMain:liftDataModel"
    };
  },
  computed: {
    params() {
