                            ...
                            <el-row>
                                ...
                                <el-col :xs="24" :sm="12" :md="12">
                                    <el-form-item label="最大载人数(人)" prop="maxPeople">
                                        <el-input-number  :max="9999999999" :precision="0"  v-model="formDatas.maxPeople" :controls="false" :disabled="edit" ></el-input-number>
                                    </el-form-item>
                                </el-col>
                                <el-col :xs="24" :sm="12" :md="12">
                                    <el-form-item label="运行速度(m/s)" prop="speed">
                                        <el-input-number  :max="9999999999" :precision="2" v-model="formDatas.speed" :controls="false" :disabled="edit" ></el-input-number>
                                    </el-form-item>
                                </el-col>
  ...
  data() {
    return {
      ...
      formDatasRules: {
        ...
        maxWeight: [
          { required: true, message: "请输入最大载重量", trigger: "blur" }
        ],
        standardHeight: [
          { required: true, message: "请输入标准高度", trigger: "blur" }
        ],
        maxPeople: [
          { required: true, message: "请输入最大载人数", trigger: "blur" }
        ],
