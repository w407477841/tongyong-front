 ...
 * @LastEditors: pangyu
 * @LastEditTime: 2019-07-02 08:16:07
 -->
    ...
    <div class="container-box list-box">
      <div class="table-box">
        ...
        >
          ...
          <el-table-column label="总预警">
            <template
              slot-scope="scope"
            >{{scope.row.weightWarn+scope.row.rangeWarn+scope.row.limitWarn+scope.row.momentWarn+scope.row.collisionWarn}}</template>
          </el-table-column>
          <el-table-column label="重量预警" prop="weightWarn"></el-table-column>
          <el-table-column label="幅度预警" prop="rangeWarn"></el-table-column>
          <el-table-column label="高度预警" prop="limitWarn"></el-table-column>
          <el-table-column label="力矩预警" prop="momentWarn"></el-table-column>
          <el-table-column label="碰撞预警" prop="collisionWarn"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //呼出短信弹框
    handleSms(row) {
      this.sms = `工程名称：${row.projectName}，塔机编号：${row.craneNo}，黑匣子编号：${row.deviceNo}，重量预警：${row.weightWarn}，幅度预警：${row.rangeWarn}，高度预警：${row.limitWarn}，力矩预警：${row.momentWarn}，碰撞预警：${row.collisionWarn}`;
