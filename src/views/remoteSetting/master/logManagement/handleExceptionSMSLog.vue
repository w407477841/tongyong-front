<template>
    <el-dialog width="80%" :title="title" :visible.sync="visibleExceptionSMSLog" append-to-body>
            ...
            <div class="container-box list-box">
                <div class="table-box">
                    <el-table size="small" :data="listData" style="width: 100%" highlight-current-row
                        ...
                        <el-table-column label="发送时间" prop="sendTime" :formatter="handleDate"></el-table-column>
                        <el-table-column label="短信内容" prop="content"></el-table-column>
                        <el-table-column label="接收人" prop="userNames"></el-table-column>
                    </el-table>
                </div>
...
<script>
    import {getExceptionSMSLog} from "@/views/remoteSetting/api/logManagement.js";
    ...
    export default {
        ...
        watch: {
            ...
            visible: {
                handler: function (val, oldVal) {
                    this.visibleExceptionSMSLog = val;
                },
                immediate: true
            },
            visibleExceptionSMSLog(val) {
                if (!val) {
                    this.$emit('close', {});
                }
            }
        ...
        methods: {
            ...
            //获取数据列表
            getListData() {
                getExceptionSMSLog(this.params).then(res => {
