<template>
  ...
  <el-form @submit.native.prevent>
    <el-form-item>
      <el-input v-model="key" placeholder="输入地址" style="width:300px"><el-button slot="append" icon="el-icon-search" @click="search"></el-button></el-input>
    </el-form-item>
    <el-form-item v-if="!this.isClose">
      <el-button @click="getProjedtScope" type="primary">确定项目范围</el-button>
    </el-form-item>
  </el-form>
  <baidu-map :center="center" id="allmap" :zoom="zoom" @ready="handler" :scroll-wheel-zoom="true" @click="getPoint" style="height : 600px">
    <bm-local-search :keyword="center" :auto-viewport="true"  v-if="this.isClose"></bm-local-search>
